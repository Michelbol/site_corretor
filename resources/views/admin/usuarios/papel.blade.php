...
@section('content')
    <div class="container">
        <h2 class="center">Lista de Papeis para {{$usuario->name}}</h2>
            ...
            <table>
                ...
                @foreach($usuario->papeis as $papel)
                    <tr>
                        ...
                        <td>
                            <a class="btn red" href="javascript: if(confirm('Deletar esse papel?')){
                            window.location.href='{{route('admin.usuarios.papel.remover',[$usuario->id,$papel->id])}}'}">Remover</a></td>
