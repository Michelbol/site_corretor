...
@section('content')
    <div class="container">
        <h2 class="center">Lista de Permissoes para {{$papel->nome}}</h2>
            ...
            <table>
                ...
                @foreach($papel->permissoes as $value)
                    <tr>
                        ...
                        <td>
                            <a class="btn red" href="javascript: if(confirm('Deletar essa Permissao?')){
                            window.location.href='{{route('admin.papel.permissao.remover',[$papel->id,$value->id])}}'}">Remover</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
